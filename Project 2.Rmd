...
model_4 <- lm(price ~ bedrooms + bathrooms + floors + grade + view + condition + waterfront + sqft_living + sqft_lot + sqft_above + sqft_living15 + sqft_lot15 + yr_built + yr_renovated + zipcode + lat + long + sqft_basement, data=house)
summary(model_4)
coef(model_4)
confint(model_4)
vif(model_4)
