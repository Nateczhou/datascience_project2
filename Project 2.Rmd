...
```{r}
testlm2 <- lm(price ~bedrooms + bathrooms + sqft_living + yr_built + yr_renovated + sqft_living15 + lat + long + floors + zipcode, data = house)
summary(testlm2)
```
...
```{r}
modelcom <- matrix(c(236009,0.586,153783, 260958,0.494,173416, 362116,0.024,231970, 208763,0.675,135348, 191991,0.726,119763, 191973,0.726,119731),ncol=3,byrow=TRUE)
